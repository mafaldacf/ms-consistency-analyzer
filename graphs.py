...
ALL_APPS = ['postnotification', 'postnotification_simple', 'trainticket', 'shopping_app', 'shopping_simple', 'sockshop2', 'foobar', 'app_constraints_referential_integrity', 'app_constraints_specialization']
ALL_GRAPHS = ['app', 'call']
