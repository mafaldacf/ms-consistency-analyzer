...
[] (-1) (BasicVariable BasicType) id string // read(train_db), 
...
[_] (0) (StructVariable StructType) struct{ "id" string,  string} // read(train_db), 
[__] (0) (FieldVariable FieldType) string // read(train_db), 
[___] (-1) (BasicVariable BasicType) id string // read(train_db), 
