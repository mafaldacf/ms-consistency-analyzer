...
[] (BasicVariable BasicType) id string // read(station_db), 
...
[_] (StructVariable StructType) struct{ "id" string,  string} // read(station_db), 
[__] (FieldVariable FieldType) string // read(station_db), 
[___] (BasicVariable BasicType) id string // read(station_db), 
