...
[] (-1) (BasicVariable BasicType) customerID string // read(order_db), 
[_] (76) (Reference BasicType) ref <userID string> @ FrontendService // read(order_db), 

[] (-1) (SliceVariable UserType) filter primitive.D // read(order_db), 
[_] (0) (StructVariable StructType) struct{ "customerid" string,  string} // read(order_db), 
[__] (0) (FieldVariable FieldType) string // read(order_db), 
[___] (-1) (BasicVariable BasicType) customerID string // read(order_db), 
[____] (76) (Reference BasicType) ref <userID string> @ FrontendService // read(order_db), 
