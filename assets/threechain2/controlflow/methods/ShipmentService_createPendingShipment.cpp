...
[__] (23) (FieldVariable FieldType) OrderID string // write(shipment_db), read(order_db), 
[___] (24) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[____] (25) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
[__] (20) (FieldVariable FieldType) Username string // write(shipment_db), 
[___] (21) (BasicVariable BasicType) Username string // write(shipment_db), 
[____] (22) (InterfaceVariable InterfaceType) Username interface{} // write(order_db), write(billing_db), write(shipment_queue), read(shipment_queue), write(shipment_db), 
[_] (0) (FieldVariable FieldType) OrderID string 
[__] (23) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[___] (24) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[____] (25) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
[__] (0) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[___] (23) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[____] (24) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[_____] (25) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
[_] (0) (FieldVariable FieldType) Username string 
[__] (20) (Reference FieldType) ref <Username string> @ ShipmentService // write(shipment_db), 
[___] (21) (BasicVariable BasicType) Username string // write(shipment_db), 
[____] (22) (InterfaceVariable InterfaceType) Username interface{} // write(order_db), write(billing_db), write(shipment_queue), read(shipment_queue), write(shipment_db), 
[__] (0) (BasicVariable BasicType) Username string // write(shipment_db), 
[___] (20) (Reference FieldType) ref <Username string> @ ShipmentService // write(shipment_db), 
[____] (21) (BasicVariable BasicType) Username string // write(shipment_db), 
[_____] (22) (InterfaceVariable InterfaceType) Username interface{} // write(order_db), write(billing_db), write(shipment_queue), read(shipment_queue), write(shipment_db), 
