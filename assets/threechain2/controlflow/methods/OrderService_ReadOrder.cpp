...
[__] (18) (Reference UserType) ref <ctx context.Context> @ ShipmentService 
...
[] (-1) (StructVariable UserType) order threechain2.Order struct{OrderID string, Username string, ProductID string, Quantity int, Timestamp int64} 
...
[_____] (23) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[______] (24) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[_______] (25) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
