...
[__] (9) (FieldVariable FieldType) Timestamp int64 // write(posts_db), 
[___] (10) (BasicVariable BasicType) timestamp int64 // write(posts_db), 
[__] (11) (FieldVariable FieldType) Creator postnotification.Creator struct{Username string} // write(posts_db), 
[___] (12) (StructVariable UserType) postnotification.Creator struct{Username string} // write(posts_db), 
[____] (13) (FieldVariable FieldType) Username "some username" string // write(posts_db), 
[_____] (14) (BasicVariable BasicType) "some username" string // write(posts_db), 
[__] (15) (FieldVariable FieldType) ReqID int64 // write(posts_db), 
...
[__] (16) (FieldVariable FieldType) PostID int64 // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
...
[__] (18) (FieldVariable FieldType) Text string // write(posts_db), 
[___] (19) (BasicVariable BasicType) text string // write(posts_db), 
[__] (20) (FieldVariable FieldType) Mentions []string // write(posts_db), 
[___] (21) (ArrayVariable ArrayType) mentions []string // write(posts_db), 
[____] (22) (BasicVariable BasicType) "alice" string // write(posts_db), 
[____] (23) (BasicVariable BasicType) "bob" string // write(posts_db), 
[_] (0) (FieldVariable FieldType) PostID int64 
[__] (16) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
[___] (-1) (BasicVariable BasicType) postID int64 // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), write(notifications_queue), read(notifications_queue), write(timeline_cache), 
[____] (46) (Reference InterfaceType) ref <PostID interface{}> @ NotifyService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), write(notifications_queue), read(notifications_queue), read(posts_db), read(analytics_db), write(timeline_cache), 
[__] (27) (BasicVariable BasicType) PostID int64 // write(analytics_queue), read(analytics_queue), write(analytics_db), 
[___] (16) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
...
[____] (16) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
