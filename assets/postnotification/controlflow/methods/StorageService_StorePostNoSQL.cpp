...
[_] (Reference BasicType) ref <reqID int64> @ UploadService // write(post_nosql), write(notif_queue), read(notif_queue), 
...
[__] (FieldVariable FieldType) ReqID int64 // write(post_nosql), 
...
[__] (FieldVariable FieldType) PostID int64 // write(post_nosql), 
