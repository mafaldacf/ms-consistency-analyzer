...
[__] (11) (FieldVariable FieldType) Text string // write(posts_db), 
[___] (12) (BasicVariable BasicType) text string // write(posts_db), 
[__] (13) (FieldVariable FieldType) Mentions []string // write(posts_db), 
[___] (14) (ArrayVariable ArrayType) mentions []string // write(posts_db), 
[____] (15) (BasicVariable BasicType) "alice" string // write(posts_db), 
[____] (16) (BasicVariable BasicType) "bob" string // write(posts_db), 
[__] (17) (FieldVariable FieldType) Timestamp int64 // write(posts_db), 
[___] (18) (BasicVariable BasicType) timestamp int64 // write(posts_db), 
[__] (4) (FieldVariable FieldType) Creator postnotification.Creator struct{Username string} // write(posts_db), 
[___] (5) (StructVariable UserType) postnotification.Creator struct{Username string} // write(posts_db), 
[____] (6) (FieldVariable FieldType) Username "some username" string // write(posts_db), 
[_____] (7) (BasicVariable BasicType) "some username" string // write(posts_db), 
[__] (8) (FieldVariable FieldType) ReqID int64 // write(posts_db), 
...
[__] (9) (FieldVariable FieldType) PostID int64 // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
...
[__] (9) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
[___] (-1) (BasicVariable BasicType) postID int64 // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), write(notifications_queue), read(notifications_queue), 
[____] (41) (Reference InterfaceType) ref <PostID interface{}> @ NotifyService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), write(notifications_queue), read(notifications_queue), read(posts_db), read(analytics_db), 
[__] (22) (BasicVariable BasicType) PostID int64 // write(analytics_queue), read(analytics_queue), write(analytics_db), 
[___] (9) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
...
[____] (9) (Reference FieldType) ref <PostID int64> @ UploadService // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
