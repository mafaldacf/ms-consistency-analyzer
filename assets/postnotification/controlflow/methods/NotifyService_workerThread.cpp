...
[____] (FieldVariable FieldType) ReqID int64 // write(post_nosql), write(notif_queue), read(notif_queue), 
[_____] (Reference InterfaceType) ref <ReqID interface{}> @ NotifyService // write(post_nosql), write(notif_queue), read(notif_queue), 
[_____] (BasicVariable BasicType) reqID int64 // write(post_nosql), write(notif_queue), read(notif_queue), 
[______] (Reference InterfaceType) ref <ReqID interface{}> @ NotifyService // write(post_nosql), write(notif_queue), read(notif_queue), 
...
[____] (FieldVariable FieldType) PostID int64 // write(post_nosql), write(notif_queue), read(notif_queue), 
...
[_____] (BasicVariable BasicType) postID int64 // write(post_nosql), write(notif_queue), read(notif_queue), 
[______] (Reference InterfaceType) ref <PostID interface{}> @ NotifyService // write(post_nosql), write(notif_queue), read(notif_queue), read(post_nosql), 
