...
[] (19) (BasicVariable BasicType) text string // write(posts_db), 
...
[] (10) (BasicVariable BasicType) timestamp int64 // write(posts_db), 

[] (21) (ArrayVariable ArrayType) mentions []string // write(posts_db), 
[_] (22) (BasicVariable BasicType) "alice" string // write(posts_db), 
[_] (23) (BasicVariable BasicType) "bob" string // write(posts_db), 
...
[_] (15) (FieldVariable FieldType) ReqID int64 // write(posts_db), 
...
[_] (16) (FieldVariable FieldType) PostID int64 // write(posts_db), write(analytics_queue), read(analytics_queue), write(analytics_db), 
...
[_] (18) (FieldVariable FieldType) Text string // write(posts_db), 
[__] (19) (BasicVariable BasicType) text string // write(posts_db), 
[_] (20) (FieldVariable FieldType) Mentions []string // write(posts_db), 
[__] (21) (ArrayVariable ArrayType) mentions []string // write(posts_db), 
[___] (22) (BasicVariable BasicType) "alice" string // write(posts_db), 
[___] (23) (BasicVariable BasicType) "bob" string // write(posts_db), 
[_] (9) (FieldVariable FieldType) Timestamp int64 // write(posts_db), 
[__] (10) (BasicVariable BasicType) timestamp int64 // write(posts_db), 
[_] (11) (FieldVariable FieldType) Creator postnotification.Creator struct{Username string} // write(posts_db), 
[__] (12) (StructVariable UserType) postnotification.Creator struct{Username string} // write(posts_db), 
[___] (13) (FieldVariable FieldType) Username "some username" string // write(posts_db), 
[____] (14) (BasicVariable BasicType) "some username" string // write(posts_db), 
