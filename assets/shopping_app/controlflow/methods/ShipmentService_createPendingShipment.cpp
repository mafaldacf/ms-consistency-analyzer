...
[__] (38) (FieldVariable FieldType) OrderID string // write(shipment_db), read(order_db), 
[___] (39) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[____] (40) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
...
[____] (43) (InterfaceVariable InterfaceType) UserID interface{} // write(order_db), write(billing_db), write(analytics_queue), read(analytics_queue), write(shipment_queue), read(shipment_queue), write(shipment_db), 
[_] (0) (FieldVariable FieldType) OrderID string 
[__] (38) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[___] (39) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[____] (40) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
[__] (0) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[___] (38) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[____] (39) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[_____] (40) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
...
[_____] (43) (InterfaceVariable InterfaceType) UserID interface{} // write(order_db), write(billing_db), write(analytics_queue), read(analytics_queue), write(shipment_queue), read(shipment_queue), write(shipment_db), 
