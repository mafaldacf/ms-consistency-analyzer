...
[_] (45) (Reference BasicType) ref <orderID string> @ Frontend // read(order_db), 
...
[_____] (38) (Reference FieldType) ref <OrderID string> @ ShipmentService // write(shipment_db), read(order_db), 
[______] (39) (BasicVariable BasicType) OrderID string // write(shipment_db), read(order_db), 
[_______] (40) (InterfaceVariable InterfaceType) OrderID interface{} // write(order_db), write(shipment_queue), read(shipment_queue), write(shipment_db), read(order_db), 
[____] (45) (Reference BasicType) ref <orderID string> @ Frontend // read(order_db), 
