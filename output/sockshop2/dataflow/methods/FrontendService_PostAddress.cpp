...
[] (81) (InterfaceVariable UserType) ctx context.Context 

[] (82) (BasicVariable BasicType) userID string 

[] (83) (StructVariable UserType) address user.Address struct{Street string, Number string, Country string, City string, PostCode string, ID string} 
