...
[___] (ArrayObject ArrayType) []cart.Item struct{ID string, Quantity int, UnitPrice float32}
[____] (StructObject UserType) item cart.Item struct{ID string, Quantity int, UnitPrice float32}
