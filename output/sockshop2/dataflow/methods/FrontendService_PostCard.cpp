...
[] (5) (InterfaceVariable UserType) ctx context.Context 

[] (6) (BasicVariable BasicType) userID string 

[] (7) (StructVariable UserType) card user.Card struct{LongNum string, Expires string, CCV string, ID string} 
