...
[] (ServiceObject ServiceType) user user.UserService

[] (ServiceObject ServiceType) catalogue catalogue.CatalogueService

[] (ServiceObject ServiceType) cart cart.CartService

[] (ServiceObject ServiceType) order order.OrderService
