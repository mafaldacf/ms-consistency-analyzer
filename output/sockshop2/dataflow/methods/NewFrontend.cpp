...
[0] (ServiceObject ServiceType) user user.UserService

[0] (ServiceObject ServiceType) catalogue catalogue.CatalogueService

[0] (ServiceObject ServiceType) cart cart.CartService

[0] (ServiceObject ServiceType) order order.OrderService
