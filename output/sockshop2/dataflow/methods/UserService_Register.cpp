...
[_] (72) (Reference BasicType) ref <username string> @ FrontendService // write(user_db), 

[] (-1) (BasicVariable BasicType) password string // write(user_db), 
[_] (73) (Reference BasicType) ref <password string> @ FrontendService // write(user_db), 

[] (-1) (BasicVariable BasicType) email string // write(user_db), 
[_] (74) (Reference BasicType) ref <email string> @ FrontendService // write(user_db), 

[] (-1) (BasicVariable BasicType) first string // write(user_db), 
[_] (75) (Reference BasicType) ref <first string> @ FrontendService // write(user_db), 

[] (-1) (BasicVariable BasicType) last string // write(user_db), 
[_] (76) (Reference BasicType) ref <last string> @ FrontendService // write(user_db), 
