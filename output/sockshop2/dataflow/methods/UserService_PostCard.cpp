...
[_] (6) (Reference BasicType) ref <userID string> @ FrontendService 

[] (-1) (StructVariable UserType) card user.Card struct{LongNum string, Expires string, CCV string, ID string} 
[_] (7) (Reference UserType) ref <card user.Card struct{LongNum string, Expires string, CCV string, ID string}> @ FrontendService 
...
[____] (6) (Reference BasicType) ref <userID string> @ FrontendService 
...
[____] (7) (Reference UserType) ref <card user.Card struct{LongNum string, Expires string, CCV string, ID string}> @ FrontendService 
