...
[] (-1) (ArrayVariable ArrayType) stations []station.Station struct{ID string, Name string, StayTime int64} 
[_] (-1) (StructVariable UserType) st station.Station struct{ID string, Name string, StayTime int64} 
