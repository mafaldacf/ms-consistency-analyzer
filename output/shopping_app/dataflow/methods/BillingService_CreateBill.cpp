...
[__] (10) (Reference BasicType) ref <userID string> @ Frontend // write(order_db), write(billing_db), write(analytics_queue), write(shipment_queue), 
...
[] (15) (BasicVariable BasicType) productID string // write(billing_db), 
...
[] (16) (BasicVariable BasicType) quantity int // write(billing_db), 
...
[_] (18) (Reference BasicType) ref <price int> @ OrderService // write(billing_db), 
[__] (13) (Reference BasicType) ref <price int> @ Frontend // write(billing_db), 
...
[__] (15) (BasicVariable BasicType) productID string // write(billing_db), 
...
[__] (16) (BasicVariable BasicType) quantity int // write(billing_db), 
...
[___] (18) (Reference BasicType) ref <price int> @ OrderService // write(billing_db), 
[____] (13) (Reference BasicType) ref <price int> @ Frontend // write(billing_db), 
[_] (0) (FieldVariable FieldType) TotalCost (&int) // write(billing_db), 
[__] (0) (AddressVariable AddressType) quantity (&int) // write(billing_db), 
[___] (16) (BasicVariable BasicType) quantity int // write(billing_db), 
[____] (16) (Reference BasicType) ref <quantity int> @ OrderService // write(order_db), write(stock_db), write(billing_db), 
[_____] (12) (Reference BasicType) ref <quantity int> @ Frontend // write(order_db), write(stock_db), write(billing_db), 
