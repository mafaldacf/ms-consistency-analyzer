...
[0] (ServiceObject ServiceType) storageService postnotification.StorageService

[0] (BlueprintBackendObject BlueprintBackendType) notificationsQueue Queue

[0] (PointerObject PointerType) n (*postnotification.NotifyServiceImpl struct{storageService postnotification.StorageService, notificationsQueue Queue, num_workers 4 int})
