...
var _ = storageservice.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  StorageService_ReadPost_Response ReadPost(StorageService_ReadPost_Request req)")
  fmt.Fprintln(os.Stderr, "  StorageService_StorePost_Response StorePost(StorageService_StorePost_Request req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "ReadPost":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "ReadPost requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    argvalue0 := storageservice.NewStorageService_ReadPost_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.ReadPost(context.Background(), value0))
    fmt.Print("\n")
    break
  case "StorePost":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "StorePost requires 1 args")
      flag.Usage()
    }
    arg20 := flag.Arg(1)
    ...
    argvalue0 := storageservice.NewStorageService_StorePost_Request()
    ...
    value0 := argvalue0
    fmt.Print(client.StorePost(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
