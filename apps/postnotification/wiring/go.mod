module github.com/blueprint-uservices/blueprint/examples/post_notification/wiring
...
require github.com/blueprint-uservices/blueprint/examples/post_notification/workflow v0.0.0 // indirect

require github.com/blueprint-uservices/blueprint/examples/post_notification/wiring/specs v0.0.0
...
replace github.com/blueprint-uservices/blueprint/examples/post_notification/wiring/specs => ./specs
