module github.com/blueprint-uservices/blueprint/examples/post_notification/wiring/specs
...
require github.com/blueprint-uservices/blueprint/examples/post_notification/workflow v0.0.0
