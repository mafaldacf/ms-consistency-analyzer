...
func (f *FrontendImpl) Test(ctx context.Context, username string, text string) (int64, error) {
	post := Post{
		ReqID:     rand.Int63(),
		PostID:    rand.Int63(),
		Text:      text,
	...
	f.storageService.StorePost(ctx, post.ReqID, post)
